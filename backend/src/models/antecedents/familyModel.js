...
export const createFamily = async (client, numero, payload, userId) => {
  const {
    diabete,
    hypertension,
    cardiopathies,
...
export const updateFamily = async (client, numero, payload, userId) => {
  const {
    diabete,
    hypertension,
    cardiopathies,
