    ...
    return (
      <div className="patient-panel">
        <div className="empty-state">
          <p className="empty-message">Aucun patient selectionne</p>
        </div>
      </div>
    );
  }
    ...
    <div className="patient-panel">
      ...
      {derniersPrises.length > 0 && (
        <div className="dernieres-prises">
          <h3 className="section-title">Dernieres prises</h3>
          <div className="prises-list">
            {derniersPrises.map((prise, index) => (
              <div key={prise.id || index} className="prise-item">
                ...
                <div className="prise-quantite">Quantite: {prise.quantite_prescrite}</div>
              </div>
            ))}
          </div>
        </div>
