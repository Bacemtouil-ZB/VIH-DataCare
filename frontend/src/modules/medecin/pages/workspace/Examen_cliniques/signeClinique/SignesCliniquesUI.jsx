        ...
        >
          ...
          <div className="d-flex gap-4 flex-wrap mb-4 pb-4 border-bottom">
            <div className="ec-flex-input">
              ...
              <input
                type="number"
                className={`form-control form-control-sm ${errors.taille ? "is-invalid" : ""}`}
                placeholder="ex: 175"
                min={1}
                max={250}
                value={taille}
            ...
            <div className="ec-flex-input">
              ...
              <input
                type="number"
                className={`form-control form-control-sm ${errors.poids ? "is-invalid" : ""}`}
                placeholder="ex: 70"
                min={1}
                max={300}
                value={poids}
                ...
                <td>
                  {si ? (
                    <span className="fw-bold">
                      {si.val} <small className="fw-normal">{si.label}</small>
                    </span>
                  ) : "N/A"}
                </td>
                <td>
          ...
          <div className="ec-readonly-block">
            ...
            <div className="d-flex gap-4 flex-wrap mb-4 pb-4 border-bottom">
              ...
              <div className="ec-flex-input-l">
                ...
                <ImcField
                  imc={
                    detailSigne.taille && detailSigne.poids
                      ? calcIMC(+detailSigne.taille, +detailSigne.poids)
                      : null
                  }
                />
              </div>
