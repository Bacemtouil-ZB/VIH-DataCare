...
// ============================================================
//  GraphiqueCD4.jsx
//  Zone 2 — AreaChart CD4 + zones ARV + seuils
// ============================================================
    ...
    >
      <ResponsiveContainer width="100%" height={CONFIG_GRAPHIQUE.hauteur}>
        ...
        >
          {/* ── Dégradé fill CD4 ── */}
          <defs>
            <linearGradient id="gradientCD4" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%"  stopColor={CONFIG_GRAPHIQUE.couleur_cd4} stopOpacity={0.25} />
              <stop offset="95%" stopColor={CONFIG_GRAPHIQUE.couleur_cd4} stopOpacity={0} />
            </linearGradient>
          </defs>
