...
export const MODULE_COLORS = {
  ...
  ANTECEDENT_FAMILIAL: "#6A1B9A",
  ANTECEDENT_GYNECO: "#D81B60",
  HABITUDE_DE_VIE: "#00897B",
  ANTECEDENT_MEDICAL: "#0277BD",
  ANTECEDENT_CHIRURGICAL: "#C62828",
  ANTECEDENT_THERAPEUTIQUE: "#E65100",
  ANTECEDENT_TPE_PREP: "#7B1FA2",
  ANTECEDENT_TRANSFUSION: "#E91E63",
};
