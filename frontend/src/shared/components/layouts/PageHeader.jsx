...
.ec-header-icon { color: var(--ec-green, #2e7d52); }
.ec-btn-ajouter { background: var(--ec-green, #2e7d52) !important; border-radius: 9px; box-shadow: 0 2px 8px rgba(46, 125, 82, 0.25); border: none; color: #fff !important; }
...
.ec-btn-annuler { border: 1px solid var(--ec-slate, #e2e8f0); border-radius: 9px; }
`;
