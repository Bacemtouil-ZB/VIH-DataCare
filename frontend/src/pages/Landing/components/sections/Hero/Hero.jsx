...
function Hero() {
  return (
    <SectionShell className="relative overflow-hidden border-b border-slate-200/80 bg-transparent py-14 md:py-20">
      ...
      <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] lg:items-center">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-6 text-4xl font-semibold leading-tight text-slate-900 md:text-[3.2rem] md:leading-[1.08]">
