...
export const createPatient = async (patientData, createdBy) => {
  const {
    ...
    birthdate,
    gender,
    birth_address_id, // nouvelle colonne
    residence_address_id, // nouvelle colonne
    exact_address, // nouvelle colonne
    phone,
    hospitalisation,
    doctor_id,
    remarques,
  ...
  const query = `
    INSERT INTO patients (
      numero_dossier, name, surname, birthdate, gender, 
      birth_address_id, residence_address_id, exact_address,
      phone, hospitalisation, doctor_id, remarques, created_by_name
    )
