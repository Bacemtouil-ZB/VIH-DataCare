...
export const putGyneco = asyncHandler(async (req, res) => {
  try {
    ...
    res.json(result);
    console.log("putGyneco success:", result);
  } catch (err) {
...
//-------------- versions-----------------
// NEW: list headers
export const getAntecedentVersions = asyncHandler(async (req, res) => {
  const data = await getVersions(req.params.numero);
  res.json(data);
});

// NEW: snapshot
export const getAntecedentVersionSnapshot = asyncHandler(async (req, res) => {
  const data = await getVersionSnapshot(
    req.params.numero,
...
// OPTIONAL: section-by-section version
export const getAntecedentVersionSection = asyncHandler(async (req, res) => {
  const data = await getVersionSection(
    req.params.numero,
    req.params.versionNumber,
