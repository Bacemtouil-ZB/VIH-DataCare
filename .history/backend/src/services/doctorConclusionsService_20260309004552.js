...
import { getPatientByNumeroOrId } from "../models/patientsModel.js"; // adapt to your project
...
export async function createPatientConclusionService({
  ...
  const patient = await getPatientByNumeroOrId({ numero: patientNumero }); // implement/adjust
  if (!patient) {
