    ...
    switch (sectionId) {
      case "medical":
        return {
          patient,
          antecedent,
          medical: await getMedical(client, antecedentId),
        };
      case "infectious":
        return {
          patient,
          antecedent,
          infectious: await getInfectious(client, antecedentId),
        };
      case "therapeutic":
        return {
          patient,
          antecedent,
          therapeutic: await getTherapeutic(client, antecedentId),
        };
      case "family":
        return {
          patient,
          antecedent,
          family: await getFamily(client, antecedentId),
        };
      case "gyneco":
        return {
          patient,
          antecedent,
          gyneco: await getGyneco(client, antecedentId),
        };
      case "surgical":
        return {
          patient,
          antecedent,
          surgical: await getSurgical(client, antecedentId),
        };
      case "transfusion":
        return {
          patient,
          antecedent,
          transfusion: await getTransfusion(client, antecedentId),
        };
      case "aes":
