...
import { getInitials, formatFrDate } from "./profil.helpers";
import "./profil.css";
    ...
    <div className="profil-header-card">
      ...
      <div className="profil-header-info">
        ...
        <div className="profil-header-meta">
          ...
          {user.isactivated ? (
            <span className="profil-badge profil-badge--active">
              <CheckCircle size={11} /> Actif
            </span>
          ) : (
            <span className="profil-badge profil-badge--inactive">
              <XCircle size={11} /> Inactif
            </span>
          )}

          <span className="profil-date-meta">
