    ...
    <div className="form-card">
      <form onSubmit={onSubmit} className="form-grid">
        ...
        <div className="form-group">
          ...
          >
            <option value="">Sélectionner</option>
            {Array.isArray(situationSocialOptions) &&
              situationSocialOptions.map((opt) => (
        ...
        <div className="form-group">
          ...
          <input
            type="number"
            name="nombre_enfants"
            value={localFormData?.nombre_enfants ?? 0}
            onChange={handleChange}
            min="0"
            disabled={!isEditing}
          />
        ...
        <div className="form-group">
          ...
          >
            <option value="">Sélectionner</option>
            {Array.isArray(niveauEtudeOptions) &&
              niveauEtudeOptions.map((opt) => (
                <option key={opt.value} value={opt.value}>
                  {opt.label}
                </option>
              ...
              problemeOptions.map((opt) => (
                <label key={opt.value}>
                  <input
                    ...
                    value={opt.value}
                    checked={
                      Array.isArray(localFormData?.probleme) &&
                      localFormData.probleme.includes(opt.value)
                    }
                    onChange={(e) =>
                      handleProblemeChange &&
                      handleProblemeChange(opt.value, e.target.checked)
                    }
                    disabled={!isEditing}
                  />
                  {opt.label}
