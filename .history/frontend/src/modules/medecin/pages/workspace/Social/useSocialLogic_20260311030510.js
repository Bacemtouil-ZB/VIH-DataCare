  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
       ...
       console.log("status:", error.response?.status); // ← ajoute ça
       console.log("error complet:", error.response);  // ← ajoute ça
            ...
            if (
                ...
                setLoading(false); // ← vérifie que cette ligne existe bien
            }
        };
