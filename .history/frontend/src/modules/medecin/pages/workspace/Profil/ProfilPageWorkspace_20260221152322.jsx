  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isNew) {
        ...
        const updatedNumero = response.patient.numero;
        toast.success("Patient mis à jour avec succès");
        setIsEditing(false);
        setInitialData(response.patient);
        if (updatedNumero !== formData.numero) {
        navigate(`/medecin/patient/${updatedNumero}/workspace/profil`, { replace: true });
  }
      }
    } catch (err) {
