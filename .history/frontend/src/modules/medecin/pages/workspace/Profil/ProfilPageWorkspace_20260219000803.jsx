    ...
    const loadData = async () => {
      try {
        ...
        if (!isNew) {
          ...
          // Mapping backend data vers formData
          setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isNew) {
        ...
        // Update formData après création pour garder valeurs
        setFormData({
          ...formData,
          id: response.id,
          birth_postal_code_id: response.birth_address_id || "",
          residence_postal_code_id: response.residence_address_id || ""
        });
        ...
        // Garder les valeurs mises à jour dans le formulaire
        setFormData({
          ...formData,
          birth_postal_code_id: updatedPatient.birth_address_id || "",
          residence_postal_code_id: updatedPatient.residence_address_id || "",
          residence_exact_address: updatedPatient.residence_exact_address || ""
        });
