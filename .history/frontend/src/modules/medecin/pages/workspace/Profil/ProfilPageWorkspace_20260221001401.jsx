...
export default function ProfilPageWorkspace() {
    ...
    const loadData = async () => {
      try {
        ...
        if (!isNew) {
          ...
          //   birth_postal_code_id: patient.birth_address_id || "",
          //   residence_postal_code_id: patient.residence_address_id || "",
          //   phone: patient.phone || "",
  ...
  birth_postal_code_id: patient.birth_postal_code_id || "", // <-- ici
  residence_governorate: patient.residence_governorate || "",
  residence_postal_code_id: patient.residence_postal_code_id || "", // <-- ici
  phone: patient.phone || "",
  hospitalisation: patient.hospitalisation || "externe",
  doctor_id: patient.doctor_id || "",
  remarks: patient.remarks || ""
