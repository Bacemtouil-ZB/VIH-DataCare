...
export default function PatientConclusionPage() {
  ...
  const handleEdit = (c) => {
    ...
    if(!canEditConclusion(c,currentDoctorId)){

      toast.warning(
        "Vous ne pouvez pas modifier la conclusion d'un autre médecin"
      );
  ...
  const handleSave = async () => {
    ...
    const error = validateConclusion(editorValue);
    ...
    try{
      ...
      if(editingItem){
        ...
        await updateConclusion(editingItem.id,{
          content:editorValue
        });
        ...
        await createPatientConclusion(numero,{
          content:editorValue
        });
  ...
  return (
    ...
    <div className="pcPage">
      ...
      <ConclusionUI
        ...
        onEdit={handleEdit}
        onPreview={()=>toast.info("Preview à implémenter")}
