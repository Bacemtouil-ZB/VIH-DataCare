...
const prettyValue = (v) => {
  ...
  // objects/arrays => keep short, but readable
  try {
                  ...
                  <>
                    <div className="auditModal__meta2">
                      ...
                      <div className="auditMetaRow">
                        ...
                        <div className="auditMetaRow__v auditMetaRow__v--mono">{txt(details.request_id)}</div>
                      </div>
                    </div>
