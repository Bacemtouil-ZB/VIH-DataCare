...
export const useAuditLogsPageLogic = () => {
  ...
  const onSearch = useCallback(
    ...
    [fetchPatient, patientNumeroInput],
  );
  ...
  const numeroHasError =
    patientNumeroInput && !isNumeroValid(patientNumeroInput);

  const numeroYearError = validateNumeroYear(patientNumeroInput);
